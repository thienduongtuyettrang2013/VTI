...
public class ScannerUtils {
    ...
    public static String inputRole(String errorMessage) {
        while (true) {
            String role = ScannerUtils.inputString(errorMessage);
            if (role.equals("EXPERIENCECANDIDATE")  ||role.equals("FRESHERCANDIDATE")) {
                return role;
            } else {
                System.err.println(errorMessage);
            }
    ...
    public static String inputGraduationRank(String errorMessage) {
        while (true) {
            String graduationRank = ScannerUtils.inputString(errorMessage);
